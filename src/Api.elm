...
corsHeader = 
    Http.header "Access-Control-Allow-Origin" "https://api.kraken.com"
...
decodeFromChange viewerDecoder val =
    ...
    -- decode that String as JSON.
    let 
       result = Decode.decodeValue (storageDecoder viewerDecoder) val
       _ = Debug.log "decodeFromChange" (Debug.toString result)
       result2 =  Result.toMaybe result
       _ = Debug.log "decodeFromChange2:" (Debug.toString result2)
    in
    result2
...
login body decoder =
    ...
    Debug.log (Debug.toString Endpoint.login)
